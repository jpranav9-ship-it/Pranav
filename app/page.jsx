...
export default function Home() {
  ...
  return (
    <main className="page">
      <nav className="nav"><a className="brand brand-link" href="/"><img src="/routeprospect-mark.svg" alt="RouteProspect" width="38" height="38" style={{display:'block',borderRadius:'10px'}} /><span>RouteProspect</span></a><div className="nav-actions"><a className="nav-link" href={demoHref}>Book a demo</a>{accountEmail ? <a className="nav-link" href="/dashboard">Workspace</a> : <a className="nav-link signin-link" href="/signin">Sign in</a>}</div></nav>
